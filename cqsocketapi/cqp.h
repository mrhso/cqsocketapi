...
CQAPI(int32_t) CQ_setGroupKick(int32_t auth_code, int64_t group_id, int64_t qq, cq_bool_t reject_add_request);
...
CQAPI(int32_t) CQ_setGroupWholeBan(int32_t auth_code, int64_t group_id, cq_bool_t enable);
CQAPI(int32_t) CQ_setGroupAdmin(int32_t auth_code, int64_t group_id, int64_t qq, cq_bool_t set);
CQAPI(int32_t) CQ_setGroupAnonymous(int32_t auth_code, int64_t group_id, cq_bool_t enable);
CQAPI(int32_t) CQ_setGroupCard(int32_t auth_code, int64_t group_id, int64_t qq, const char *new_card);
CQAPI(int32_t) CQ_setGroupLeave(int32_t auth_code, int64_t group_id, cq_bool_t is_dismiss);
...
CQAPI(const char *) CQ_getStrangerInfo(int32_t auth_code, int64_t qq, cq_bool_t no_cache);
...
CQAPI(const char *) CQ_getGroupMemberInfoV2(int32_t auth_code, int64_t group_id, int64_t qq, cq_bool_t no_cache);
